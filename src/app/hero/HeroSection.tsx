    ...
    <main className="min-h-screen bg-background text-foreground relative overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex flex-col px-layout">
        ...
        <div className="flex-1 flex flex-col justify-center py-8">
          <h1 className="text-hero leading-[0.9] tracking-hero border-b border-white/10 max-md:text-hero-mobile">SUMIT</h1>
          <h1 className="text-hero leading-[0.9] tracking-hero text-right max-md:text-hero-mobile">PATEL</h1>
        </div>
