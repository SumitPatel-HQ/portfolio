    ...
    >
      <div className="relative mx-auto grid w-full grid-cols-1 gap-10 rounded-3xl p-8 md:grid-cols-12 md:gap-8">
        <div className="md:col-span-9">
          ...
          <div className="border-t max-w-5xl border-white/10 opacity-80" />
          <div className="pt-6">
        ...
        {/* Big circle Bot */}
        <div className="md:col-span-3 md:flex md:items-center md:justify-center mt-10 md:mt-0 relative z-20">
          <ContactOrb />
        </div>
      </div>
    </section>
